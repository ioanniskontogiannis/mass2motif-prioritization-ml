...
dataset_parameters = {
    ...
    "output_folder": "/lustre/BIF/nobackup/konto008/thesis_data/new_positive_gnps_1000", 
}
...
dataset = list(load_from_mgf("/lustre/BIF/nobackup/konto008/new_ms2lda_runs_input/GNPS_without_mnslib_pos.mgf"))
