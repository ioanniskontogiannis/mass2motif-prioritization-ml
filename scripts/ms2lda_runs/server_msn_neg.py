...
annotation_parameters = {
    ...
    "s2v_model_path": "/lustre/BIF/nobackup/konto008/MS2LDA/MS2LDA/Add_On/Spec2Vec/model_negative_mode/061125_s2v_filtered_neg.model",
    "s2v_library_embeddings": "/lustre/BIF/nobackup/konto008/MS2LDA/MS2LDA/Add_On/Spec2Vec/model_negative_mode/061125_filtered_Spec2Vec_neg_embeddings.npy",
...
model_parameters = {
    ...
    "min_cf": 0,
    "min_df": 3,
    "alpha": 0.02, #A higher alpha makes the document preferences "smoother" over topics
    "eta": 0.005, #and a higher eta makes the topic preferences "smoother" over words.
    "seed": 42,
}
...
dataset_parameters = {
    ...
    "output_folder": "/lustre/BIF/nobackup/konto008/thesis_data/new_negative_msn_400", 
}
...
dataset = list(load_from_mgf("/lustre/BIF/nobackup/konto008/new_ms2lda_runs_input/msn_negative_filtered.mgf"))
